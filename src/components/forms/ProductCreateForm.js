...
export const ProductCreateForm = ({values,handleSubmit, handleChange, handleCategoryChange, subOptions, showSub}) => {
    ...
    return (
        ...
        {subOptions ? subOptions.length : "No suboptions added"}
